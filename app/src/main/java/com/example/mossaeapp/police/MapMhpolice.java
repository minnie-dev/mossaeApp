...
public class MapMhpolice extends Activity implements OnMapReadyCallback {
    GoogleMap gMap;
    MapFragment mapFrag;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mhpolice);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        markermh.position(new LatLng(37.389579, 126.930556 )).title("명학 지구대").snippet("031-446-0112");
        markermh.icon(BitmapDescriptorFactory.fromResource(R.drawable.policemark));





                gMap.addMarker(markermh).showInfoWindow();
