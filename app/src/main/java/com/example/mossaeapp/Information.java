    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        help.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), Helpinformation.class);
        ...
        //쇼핑사이트버튼
        ImageButton shoppingsite = (ImageButton) findViewById((R.id.shoppingsite));
        shoppingsite.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                Uri uri = Uri.parse("http://www.damool.com/shop/shopbrand.html?type=X&xcode=068");
