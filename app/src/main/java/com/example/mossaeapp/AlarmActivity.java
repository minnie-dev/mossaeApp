...
public class AlarmActivity extends AppCompatActivity {
    ...
    void setAlarm() {
        ...
        Toast.makeText(getBaseContext(), Time.getTime() + "에 알람이 울립니다.", Toast.LENGTH_SHORT).show();
    ...
    void removeAlarm() {
        ...
        ServicePending = PendingIntent.getBroadcast(
                AlarmActivity.this, 111, intent, PendingIntent.FLAG_UPDATE_CURRENT);
        Toast.makeText(getBaseContext(), "예약 전화가 취소되었습니다.", Toast.LENGTH_SHORT).show();
        alarmManager.cancel(ServicePending);
        textView.setText("설정된 시간이 없습니다.");
    }
}
